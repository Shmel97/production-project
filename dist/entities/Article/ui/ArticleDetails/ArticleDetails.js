...
export var ArticleDetails = memo(function (_a) {
    ...
    var content;
    if (isLoading) {
        content = (_jsxs(_Fragment, { children: [_jsx(Skeleton, { className: cls.avatar, width: 200, height: 200, borderRadius: "50%" }, void 0), _jsx(Skeleton, { className: cls.title, width: 300, height: 30 }, void 0), _jsx(Skeleton, { className: cls.skeleton, width: 400, height: 30 }, void 0), _jsx(Skeleton, { className: cls.skeleton, width: "100%", height: 200 }, void 0), _jsx(Skeleton, { className: cls.skeleton, width: "100%", height: 200 }, void 0)] }, void 0));
    }
    else if (error) {
        content = (_jsx(Text, { align: TextAlign.CENTER, title: t('Упс... Произошла ошибка при загрузке статьи.') }, void 0));
    }
    else {
        content = (_jsxs(_Fragment, { children: [_jsx("div", __assign({ className: cls.avatarWrapper }, { children: _jsx(Avatar, { size: 200, src: article === null || article === void 0 ? void 0 : article.img, className: cls.avatar }, void 0) }), void 0), _jsx(Text, { className: cls.title, title: article === null || article === void 0 ? void 0 : article.title, text: article === null || article === void 0 ? void 0 : article.subtitle, size: TextSize.L }, void 0), _jsxs("div", __assign({ className: cls.articleInfo }, { children: [_jsx(Icon, { Svg: EyeIcon, className: cls.icon }, void 0), _jsx(Text, { text: String(article === null || article === void 0 ? void 0 : article.views) }, void 0)] }), void 0), _jsxs("div", __assign({ className: cls.articleInfo }, { children: [_jsx(Icon, { Svg: CalendarIcon, className: cls.icon }, void 0), _jsx(Text, { text: article === null || article === void 0 ? void 0 : article.createdAt }, void 0)] }), void 0), article === null || article === void 0 ? void 0 : article.blocks.map(renderBlock)] }, void 0));
    }
